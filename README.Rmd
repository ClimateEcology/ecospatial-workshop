...
This workshop is designed to introduce users to the new [**beeshiny app**](https://beesuite.psu.edu/beeshiny/){target="_blank"}. 

beeshiny can be used to query data commonly used when modeling the environemental drivers of species' or commmunity responses. beeshiny was originally build as a companion to [Beescape](https://beescape.psu.edu/){target="_blank"}. 
...
* We will use data downloaded from the [**beeshiny app**](https://beesuite.psu.edu/beeshiny/){target="_blank"}.
...
Use [**beeshiny**](https://beesuite.psu.edu/beeshiny/){target="_blank"} to download the cropland data layer (CDL) raster for **Centre County, Pennsylvania** for the year **2021**.
...
Then we can recolor the classes to match the traditional [NASS CDL style](https://www.nass.usda.gov/Research_and_Science/Cropland/docs/US_2023_CDL_legend.jpg){target="_blank"}.
...
Up to know, our CDL raster values are still numeric values that represent crop land cover class from the CDL. We can reclassify these CDL values to the estimated floral resources of each land cover class, based on [Koh et al. (2015)](https://www.pnas.org/doi/abs/10.1073/pnas.1517685113){target="_blank"}.

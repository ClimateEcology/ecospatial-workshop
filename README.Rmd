...
This workshop is designed to introduce users to the new [**beeshiny**](https://beesuite.psu.edu/beeshiny/) R shiny application. 

[**beeshiny**](https://beesuite.psu.edu/beeshiny/) can be used to query data commonly used when modeling the environemental drivers of species' or commmunity responses. beeshiny was originally build as a companion to [Beescape](https://beescape.psu.edu/). 

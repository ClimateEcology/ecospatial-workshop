...
```
 However, while the CDL Class Names are stored as values these have no numeric meaning. They simply correspond to a land cover class. 
 
 #TODO: convert to CDL class values from lookup table
...
ggplot() +
  ...
  scale_fill_grass_d(palette = "rainbow", na.value="transparent")
```

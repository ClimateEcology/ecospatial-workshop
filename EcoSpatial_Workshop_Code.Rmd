...
```{r }
coltab(county_cdl) <- cdl_colormap
...
<<<<<<< HEAD
4. Replace the CDL value codes with the land cover class names and CDL color values
=======
4. Define CDL value codes with land cover class names and assign colors using `cdl_colormap`

>>>>>>> aed878057c9cdcab2314cff517be2b1e58e3c5e8
...
In the /data directory you should find a csv file with a set of points from Centre County Pa. 
```{r read in pts}
